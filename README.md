...
- Extracted and cleaned a 7.5 GB raw dataset using pandas, integrating Fragile States Index and World Bank data to create a final dataset of 30 countries (15 fragile, 15 non-fragile) from 2006-2022.

- Developed three alternative hypotheses suggesting that “External Intervention” has negative relationships with H1 - “State Legitimacy”, H2 - “Political Stability & Absence of Violence”, H3 - “Rule of Law”.
...
- Generated a correlation matrix heatmap (seaborn, Matplotlib), displaying correlations between “External Intervention” and Governance variables.

- Designed scatter plots (Matplotlib) showing general trends, such as fragile states with high levels of “External Intervention” often struggle with weak “Rule of Law”, while non-fragile states with limited external involvement show strong legal frameworks.
